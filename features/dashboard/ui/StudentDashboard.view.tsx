...
import type { CourseWithProgress, Lesson, ActivityLog, ActivityType } from "@/lib/types/api";
...
export function StudentDashboardView(props: StudentDashboardViewProps) {
  const { courses, daysSinceEnrollment, nextLesson, recentLogs, isLoading,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="cursor-pointer border-pink-200 bg-pink-50/50 transition-shadow hover:shadow-md">
          <CardContent className="p-5">
            <p className="text-xs font-medium text-pink-600">おすすめレッスン →</p>
            <h3 className="mt-1 font-semibold">コンテンツSEO戦略</h3>
            <p className="mt-1 text-sm text-muted-foreground">Trending Now</p>
          </CardContent>
        </Card>
      </div>
